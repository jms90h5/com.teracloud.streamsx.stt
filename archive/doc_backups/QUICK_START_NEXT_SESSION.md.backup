...
cd test
./test_real_nemo_fixed --nemo-model ../models/nemo_fastconformer_streaming/conformer_ctc_dynamic.onnx ...
```

## Key Files
- **Working Model**: `models/fastconformer_nemo_export/ctc_model.onnx` (471MB)
- **Working Features**: `working_input.bin` (min=-10.73, max=6.68)
- **Wrong Model**: `models/nemo_fastconformer_streaming/conformer_ctc_dynamic.onnx` (2.6MB)
