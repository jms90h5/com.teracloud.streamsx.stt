...
check_audio_file("opt/opt/test_data/audio/librispeech-1995-1837-0001.wav")

# Create a short version for testing
create_short_test_audio(
    "opt/opt/test_data/audio/librispeech-1995-1837-0001.wav",
    "opt/opt/test_data/audio/librispeech_3sec.wav",
    3.0
)
...
print("\n=== Other test files ===")
import os
test_dir = "opt/opt/test_data/audio"
