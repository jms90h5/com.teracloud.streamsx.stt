...
Expected Output:
    - models/fastconformer_ctc_export/model.onnx (40MB+ expected)
    - models/fastconformer_ctc_export/tokens.txt (1000+ tokens expected)
...
def main():
    ...
    output_dir = "models/fastconformer_ctc_export"  # Path that samples expect!
