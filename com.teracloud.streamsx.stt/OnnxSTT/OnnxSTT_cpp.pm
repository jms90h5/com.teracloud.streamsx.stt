...
sub main::generate($$) {
   ...
   print '    , streaming_mode_(';
   print $streamingMode;
   print ')', "\n";
   print '    , chunk_overlap_ms_(';
   print $chunkOverlapMs;
   print ') {', "\n";
   print '    ', "\n";
   print '    SPLAPPTRC(L_DEBUG, "OnnxSTT operator constructor", "OnnxSTT");', "\n";
   print '    SPLAPPTRC(L_DEBUG, "Streaming mode: " + std::string(streaming_mode_ ? "enabled" : "disabled"), "OnnxSTT");', "\n";
   print '}', "\n";
   print "\n";
   print 'MY_OPERATOR_SCOPE::MY_OPERATOR::~MY_OPERATOR() {', "\n";
   ...
   print ';', "\n";
   print '        ', "\n";
   print '        // Handle "none" for CMVN path (NeMo models don\'t use CMVN)', "\n";
   print '        std::string cmvnPath = ';
   print $cmvnFile;
   print ';', "\n";
   print '        if (cmvnPath != "none") {', "\n";
   print '            config_.cmvn_stats_path = cmvnPath;', "\n";
   print '        } else {', "\n";
   print '            config_.cmvn_stats_path = "";  // Empty string indicates no CMVN', "\n";
   print '        }', "\n";
   print '        ', "\n";
   ...
   print ';', "\n";
   print '        ', "\n";
   print '        // Set model type', "\n";
   print '        std::string modelTypeStr = ';
   print $modelType;
   print ';', "\n";
   print '        if (modelTypeStr == "NEMO_CTC") {', "\n";
   print '            config_.model_type = onnx_stt::OnnxSTTInterface::ModelType::NEMO_CTC;', "\n";
   print '        } else {', "\n";
   print '            config_.model_type = onnx_stt::OnnxSTTInterface::ModelType::CACHE_AWARE_CONFORMER;', "\n";
   print '        }', "\n";
   print '        ', "\n";
   print '        // Set blank ID for CTC decoding', "\n";
   print '        config_.blank_id = ';
   print $blankId;
   print ';', "\n";
   print '        ', "\n";
   print '        SPLAPPTRC(L_INFO, "Initializing OnnxSTT with model: " + config_.encoder_onnx_path + ', "\n";
   print '                          ", type: " + modelTypeStr + ", blank_id: " + std::to_string(config_.blank_id), "OnnxSTT");', "\n";
   print '        SPLAPPTRC(L_DEBUG, "CMVN path: " + (config_.cmvn_stats_path.empty() ? "none" : config_.cmvn_stats_path), "OnnxSTT");', "\n";
   print '        SPLAPPTRC(L_DEBUG, "Sample rate: " + std::to_string(config_.sample_rate) + ', "\n";
   print '                          ", chunk size: " + std::to_string(config_.chunk_size_ms) + "ms", "OnnxSTT");', "\n";
   print '        ', "\n";
   ...
   print '        }', "\n";
   print '        ', "\n";
   print '        // Initialize streaming buffer if in streaming mode', "\n";
   print '        if (streaming_mode_) {', "\n";
   print '            size_t chunk_samples = (config_.chunk_size_ms * config_.sample_rate) / 1000;', "\n";
   print '            size_t overlap_samples = (chunk_overlap_ms_ * config_.sample_rate) / 1000;', "\n";
   print '            size_t buffer_capacity = chunk_samples * 10; // Buffer up to 10 chunks', "\n";
   print '            ', "\n";
   print '            streaming_buffer_ = std::make_unique<onnx_stt::StreamingBuffer>(', "\n";
   print '                buffer_capacity, chunk_samples, overlap_samples);', "\n";
   print '            ', "\n";
   print '            SPLAPPTRC(L_INFO, "Streaming buffer initialized: chunk=" + std::to_string(chunk_samples) + ', "\n";
   print '                             " samples, overlap=" + std::to_string(overlap_samples) + " samples", "OnnxSTT");', "\n";
   print '        }', "\n";
   print '        ', "\n";
   ...
   print '    ', "\n";
   print '    SPLAPPTRC(L_DEBUG, "Processing audio chunk: " + std::to_string(num_samples) + ', "\n";
   print '                      " samples at timestamp " + std::to_string(audio_timestamp_ms_) + "ms", "OnnxSTT");', "\n";
   print '    ', "\n";
   ...
   print '        SPLAPPTRC(L_DEBUG, "Transcription result: \\"" + result.text + ', "\n";
   print '                          "\\" (confidence: " + std::to_string(result.confidence) + ")", "OnnxSTT");', "\n";
